...
class py_agent(
  ...
  py_agent::initialize { $deployment_code:
    repo      => $package_repo,
    version   => $version,
  ...
  py_agent::push_templates {  $service_templates:
      target    => $agent_home,
